...
var Box2D, Vector, Vector_a2j_Number, i;

Box2D = {};

(function(a2j, undefined_) {
  ...
  - darkoverlordofdata
   */
  var NVector, emptyFn, equal, generateCallback;
  emptyFn = function() {};
  ...
  a2j.generateCallback = generateCallback = function(context, cb) {
    return function() {
      cb.apply(context, arguments);
    };
  };
  a2j.NVector = NVector = function(length) {
    var i, tmp;
    if (length === undefined) {
      length = 0;
    }
    tmp = new Array(length || 0);
    i = 0;
    while (i < length) {
      tmp[i] = 0;
      ++i;
  ...
  a2j.is = equal = function(o1, o2) {
    ...
    if ((o1.constructor.__implements != null) && o1.constructor.__implements[o2]) {
      return true;
    }
    return false;
  };
...
(function() {
  ...
  b2DynamicTreeBroadPhase = function() {
    b2DynamicTreeBroadPhase.b2DynamicTreeBroadPhase.apply(this, arguments);
  };
  b2DynamicTreeNode = function() {
    b2DynamicTreeNode.b2DynamicTreeNode.apply(this, arguments);
  };
  b2DynamicTreePair = function() {
  ...
  b2Shape = function() {
    ...
    if (this.constructor === b2Shape) {
      this.b2Shape.apply(this, arguments);
    }
  };
  b2Color = function() {
    b2Color.b2Color.apply(this, arguments);
    if (this.constructor === b2Color) {
  ...
  b2Mat22 = function() {
    ...
    if (this.constructor === b2Mat22) {
      this.b2Mat22.apply(this, arguments);
    }
  };
  b2Mat33 = function() {
    b2Mat33.b2Mat33.apply(this, arguments);
    if (this.constructor === b2Mat33) {
  ...
  b2Vec2 = function() {
    ...
    if (this.constructor === b2Vec2) {
      this.b2Vec2.apply(this, arguments);
    }
  };
  b2Vec3 = function() {
    b2Vec3.b2Vec3.apply(this, arguments);
    if (this.constructor === b2Vec3) {
      this.b2Vec3.apply(this, arguments);
    }
  };
  b2Body = function() {
    b2Body.b2Body.apply(this, arguments);
    if (this.constructor === b2Body) {
  ...
  b2World = function() {
    ...
    if (this.constructor === b2World) {
      this.b2World.apply(this, arguments);
    }
  };
  b2CircleContact = function() {
  ...
  b2EdgeAndCircleContact = function() {
    b2EdgeAndCircleContact.b2EdgeAndCircleContact.apply(this, arguments);
  };
  b2NullContact = function() {
    b2NullContact.b2NullContact.apply(this, arguments);
    if (this.constructor === b2NullContact) {
      this.b2NullContact.apply(this, arguments);
    }
  };
  b2PolyAndCircleContact = function() {
    b2PolyAndCircleContact.b2PolyAndCircleContact.apply(this, arguments);
  };
  b2PolyAndEdgeContact = function() {
  ...
  b2BuoyancyController = function() {
    b2BuoyancyController.b2BuoyancyController.apply(this, arguments);
  };
  b2ConstantAccelController = function() {
    b2ConstantAccelController.b2ConstantAccelController.apply(this, arguments);
  };
  b2ConstantForceController = function() {
  ...
  b2GravityController = function() {
    b2GravityController.b2GravityController.apply(this, arguments);
  };
  b2TensorDampingController = function() {
    b2TensorDampingController.b2TensorDampingController.apply(this, arguments);
  };
  b2DistanceJoint = function() {
...
(function() {
  var ClipVertex, Features, IBroadPhase, b2AABB, b2Bound, b2BoundValues, b2CircleShape, b2Collision, b2Color, b2ContactID, b2ContactPoint, b2Distance, b2DistanceInput, b2DistanceOutput, b2DistanceProxy, b2DynamicTree, b2DynamicTreeBroadPhase, b2DynamicTreeNode, b2DynamicTreePair, b2EdgeChainDef, b2EdgeShape, b2Manifold, b2ManifoldPoint, b2MassData, b2Mat22, b2Mat33, b2Math, b2Point, b2PolygonShape, b2RayCastInput, b2RayCastOutput, b2Segment, b2SeparationFunction, b2Settings, b2Shape, b2Simplex, b2SimplexCache, b2SimplexVertex, b2Sweep, b2TOIInput, b2TimeOfImpact, b2Transform, b2Vec2, b2Vec3, b2WorldManifold, b2internal;
  ...
  b2DynamicTreeBroadPhase.prototype.UpdatePairs = function(callback) {
    var QueryCallback, __this, fatAABB, i, pair, primaryPair, queryProxy, userDataA, userDataB;
    __this = this;
...
(function() {
  var ClipVertex, Features, IBroadPhase, b2AABB, b2Body, b2BodyDef, b2Bound, b2BoundValues, b2CircleShape, b2Collision, b2Color, b2ContactFilter, b2ContactID, b2ContactImpulse, b2ContactListener, b2ContactManager, b2ContactPoint, b2DebugDraw, b2DestructionListener, b2Distance, b2DistanceInput, b2DistanceOutput, b2DistanceProxy, b2DynamicTree, b2DynamicTreeBroadPhase, b2DynamicTreeNode, b2DynamicTreePair, b2EdgeChainDef, b2EdgeShape, b2FilterData, b2Fixture, b2FixtureDef, b2Island, b2Manifold, b2ManifoldPoint, b2MassData, b2Mat22, b2Mat33, b2Math, b2Point, b2PolygonShape, b2RayCastInput, b2RayCastOutput, b2Segment, b2SeparationFunction, b2Settings, b2Shape, b2Simplex, b2SimplexCache, b2SimplexVertex, b2Sweep, b2TOIInput, b2TimeOfImpact, b2TimeStep, b2Transform, b2Vec2, b2Vec3, b2World, b2WorldManifold, b2internal;
  b2Color = Box2D.Common.b2Color;
  b2internal = Box2D.Common.b2internal;
  b2Settings = Box2D.Common.b2Settings;
  b2CircleShape = Box2D.Collision.Shapes.b2CircleShape;
...
(function() {
  var b2Color, b2Mat22, b2Mat33, b2Math, b2Settings, b2Sweep, b2Transform, b2Vec2, b2Vec3, b2internal;
  b2Color = Box2D.Common.b2Color;
  b2internal = Box2D.Common.b2internal;
  b2Settings = Box2D.Common.b2Settings;
  b2Mat22 = Box2D.Common.Math.b2Mat22;
  ...
  b2Settings.b2MixRestitution = function(restitution1, restitution2) {
    if (restitution1 === undefined) {
      restitution1 = 0;
    }
    if (restitution2 === undefined) {
      restitution2 = 0;
    }
...
(function() {
  var b2AABB, b2Color, b2Mat22, b2Mat33, b2Math, b2Settings, b2Sweep, b2Transform, b2Vec2, b2Vec3, b2internal;
  b2AABB = Box2D.Collision.b2AABB;
  b2Color = Box2D.Common.b2Color;
  b2internal = Box2D.Common.b2internal;
  b2Settings = Box2D.Common.b2Settings;
...
(function() {
  ...
  b2Island.prototype.Initialize = function(bodyCapacity, contactCapacity, jointCapacity, allocator, listener, contactSolver) {
    var i;
    if (bodyCapacity === undefined) {
      bodyCapacity = 0;
    }
    if (contactCapacity === undefined) {
      contactCapacity = 0;
    }
    if (jointCapacity === undefined) {
      jointCapacity = 0;
    }
    i = 0;
...
(function() {
  var ClipVertex, Features, IBroadPhase, b2AABB, b2Body, b2BodyDef, b2Bound, b2BoundValues, b2CircleContact, b2CircleShape, b2Collision, b2Color, b2Contact, b2ContactConstraint, b2ContactConstraintPoint, b2ContactEdge, b2ContactFactory, b2ContactFilter, b2ContactID, b2ContactImpulse, b2ContactListener, b2ContactManager, b2ContactPoint, b2ContactRegister, b2ContactResult, b2ContactSolver, b2DebugDraw, b2DestructionListener, b2Distance, b2DistanceInput, b2DistanceOutput, b2DistanceProxy, b2DynamicTree, b2DynamicTreeBroadPhase, b2DynamicTreeNode, b2DynamicTreePair, b2EdgeAndCircleContact, b2EdgeChainDef, b2EdgeShape, b2FilterData, b2Fixture, b2FixtureDef, b2Island, b2Manifold, b2ManifoldPoint, b2MassData, b2Mat22, b2Mat33, b2Math, b2NullContact, b2Point, b2PolyAndCircleContact, b2PolyAndEdgeContact, b2PolygonContact, b2PolygonShape, b2PositionSolverManifold, b2RayCastInput, b2RayCastOutput, b2Segment, b2SeparationFunction, b2Settings, b2Shape, b2Simplex, b2SimplexCache, b2SimplexVertex, b2Sweep, b2TOIInput, b2TimeOfImpact, b2TimeStep, b2Transform, b2Vec2, b2Vec3, b2World, b2WorldManifold, b2internal;
  b2CircleShape = Box2D.Collision.Shapes.b2CircleShape;
  b2EdgeChainDef = Box2D.Collision.Shapes.b2EdgeChainDef;
  b2EdgeShape = Box2D.Collision.Shapes.b2EdgeShape;
  b2MassData = Box2D.Collision.Shapes.b2MassData;
  ...
  b2Contact.prototype.Reset = function(fixtureA, fixtureB) {
    var bodyA, bodyB;
    if (fixtureA === undefined) {
      fixtureA = null;
    }
    if (fixtureB === undefined) {
      fixtureB = null;
    }
    this.m_flags = b2Contact.e_enabledFlag;
...
(function() {
  var b2Body, b2BodyDef, b2BuoyancyController, b2CircleShape, b2Color, b2ConstantAccelController, b2ConstantForceController, b2ContactFilter, b2ContactImpulse, b2ContactListener, b2ContactManager, b2Controller, b2ControllerEdge, b2DebugDraw, b2DestructionListener, b2EdgeChainDef, b2EdgeShape, b2FilterData, b2Fixture, b2FixtureDef, b2GravityController, b2Island, b2MassData, b2Mat22, b2Mat33, b2Math, b2PolygonShape, b2Settings, b2Shape, b2Sweep, b2TensorDampingController, b2TimeStep, b2Transform, b2Vec2, b2Vec3, b2World, b2internal;
  b2Body = Box2D.Dynamics.b2Body;
  b2BodyDef = Box2D.Dynamics.b2BodyDef;
  b2ContactFilter = Box2D.Dynamics.b2ContactFilter;
  b2ContactImpulse = Box2D.Dynamics.b2ContactImpulse;
  ...
  b2TensorDampingController.prototype.SetAxisAligned = function(xDamping, yDamping) {
    if (xDamping === undefined) {
      xDamping = 0;
    }
    if (yDamping === undefined) {
      yDamping = 0;
    }
...
(function() {
  var b2Body, b2BodyDef, b2Color, b2ContactFilter, b2ContactImpulse, b2ContactListener, b2ContactManager, b2DebugDraw, b2DestructionListener, b2DistanceJoint, b2DistanceJointDef, b2FilterData, b2Fixture, b2FixtureDef, b2FrictionJoint, b2FrictionJointDef, b2GearJoint, b2GearJointDef, b2Island, b2Jacobian, b2Joint, b2JointDef, b2JointEdge, b2LineJoint, b2LineJointDef, b2Mat22, b2Mat33, b2Math, b2MouseJoint, b2MouseJointDef, b2PrismaticJoint, b2PrismaticJointDef, b2PulleyJoint, b2PulleyJointDef, b2RevoluteJoint, b2RevoluteJointDef, b2Settings, b2Sweep, b2TimeStep, b2Transform, b2Vec2, b2Vec3, b2WeldJoint, b2WeldJointDef, b2World, b2internal;
  b2Color = Box2D.Common.b2Color;
  b2internal = Box2D.Common.b2internal;
  b2Settings = Box2D.Common.b2Settings;
  b2Mat22 = Box2D.Common.Math.b2Mat22;
